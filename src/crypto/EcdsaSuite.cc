...
SignatureKeyPair EcdsaSuite::generateKeypair() const {
    SignatureKeyPair kp;
...
Bytes EcdsaSuite::publicKeyBytes(const SignatureKeyPair& kp) const {
...
std::unique_ptr<SignatureKeyPair> EcdsaSuite::keyFromPublicBytes(const Bytes& spki) const {
...
Bytes EcdsaSuite::sign(const SignatureKeyPair& kp, const Bytes& message) const {
...
bool EcdsaSuite::verify(const SignatureKeyPair& kp, const Bytes& message,
